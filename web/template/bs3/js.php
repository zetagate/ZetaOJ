...
msg = "";
  ...
  $("body").append("<div id=footer class=center ><a href='https://github.com/zetagate' >(C) 2017 Zeta Online Judge</a>  </div>");
  $("body").append("<div id=footer class=center >GPLv2 <a href='https://github.com/zhblue/hustoj' >HUSTOJ</a> "+(new Date()).getFullYear()+" </div>");
});
