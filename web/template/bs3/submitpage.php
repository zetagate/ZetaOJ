...
<br>
<div>
<label class="radio-inline"><input type="radio" name="share" checked="checked" value="true">공개</label>
<label class="radio-inline"><input type="radio" name="share" value="false">비공개</label>
</div>
<?php if($OJ_VCODE){?>
<?php echo $MSG_VCODE?>:
